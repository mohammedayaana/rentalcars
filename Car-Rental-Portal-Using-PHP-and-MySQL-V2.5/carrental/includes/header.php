    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/OIG.jpeg" width = "100" height= "100" alt="image"/></a> </div>
        </div>
...
echo "Welcome to the pinnacle of automotive excellence at Top G Cars, where driving dreams take the lead!";
 } ?>
          </div>
        </div>
      </div>
